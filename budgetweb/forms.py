...
class DepenseFullForm ( forms.ModelForm ):
    ...
    class Meta:
        model = DepenseFull
        fields = ( 'id','myid' , 'structlev3' , 'cptdeplev1', 'domfonc' ,
                   'plfi' , 'montantdc', 'montantcp' , 'montantae' ,'dateae', 'commentaire' , 'periodebudget','myfile' )
...
class DepenseFullFormPfifleche ( forms.ModelForm ):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['cptdeplev1'].queryset = NatureComptable.objects.filter(nctype='dep',pfifleche=True).order_by('enveloppe')
...
class DepenseFullFormPfinonfleche ( forms.ModelForm ):
    ...
    def __init__(self,*args,**kwargs):
        super (DepenseFullFormPfinonfleche,self ).__init__(*args,**kwargs) # populates the post
        self.fields['cptdeplev1'].queryset = NatureComptable.objects.filter(nctype='dep',pfifleche=False).order_by('enveloppe')
...
class RecetteFullForm ( forms.ModelForm ):
    ...
    class Meta:
        model = RecetteFull
        fields = ( 'myid' , 'structlev3' , 'cptdeplev1' , 'domfonc' ,
                   'plfi' , 'montantar', 'montantre' ,'montantdc', 'commentaire' , 'periodebudget','myfile' )
