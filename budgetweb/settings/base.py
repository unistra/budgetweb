...
# engine : sqlite3
# name : PROJECT_ROOT_DIR/budgetweb.db

# defaut db connection
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'budgetweb',                      # Or path to database file if using sqlite3.
        'USER': '',
        'PASSWORD': '',
...
CAS_SERVER_URL = 'https://FIXIT/cas/login'
CAS_LOGOUT_REQUEST_ALLOWED = ('FIXIT CAS1', 'FIXIT CAS2')
