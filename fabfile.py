...
env.application_name = 'budgetweb'   # name of webapp
...
def dev():
    ...
    env.server_name = 'budgetweb-dev.net'
    env.short_server_name = 'budgetweb-dev'
...
def preprod():
    ...
    env.roledefs = {
        'web': ['budgetweb-pprd.net'],
        'lb': ['lb.budgetweb-pprd.net'],
    }
    # env.user = 'root'  # user for ssh
    env.backends = env.roledefs['web']
    env.server_name = 'budgetweb-pprd.net'
    env.short_server_name = 'budgetweb-pprd'
    env.static_folder = '/site_media/'
    env.server_ip = ''
    env.no_shared_sessions = False
    env.server_ssl_on = True
